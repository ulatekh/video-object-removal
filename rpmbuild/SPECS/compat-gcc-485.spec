...
Patch1500: gcc48-asan-signal.patch
Patch1501: gcc48-sanitizers.patch
Patch1502: gcc48-ucontext.patch
...
# Required to disable the annobin feature.
%undefine _annotated_build
# And avoid extra hardening for the old compiler as well.
%undefine _hardened_build

%description
This package includes a GCC 4.8.5 compatibility compiler.
...
%package c++
Summary: C++ support for GCC 4.8.5 compatibility compiler
Group: Development/Languages
Requires: compat-gcc-48 = %{version}-%{release}
...
%description c++
This package includes a GCC 4.8.5 compatibility C++ compiler.

%package -n compat-libstdc++-48
...
%description -n compat-libstdc++-48
The libstdc++ package contains a rewritten standard compliant GCC Standard
C++ Library.

%package -n compat-libstdc++-48-devel
Summary: Header files and libraries for C++ development
Group: Development/Libraries
Requires: compat-libstdc++-48%{?_isa} = %{version}-%{release}
Autoreq: true
%if "%{version}" != "%{gcc_version}"
%endif

%description -n compat-libstdc++-48-devel
This is the GNU implementation of the standard C++ libraries.  This
package includes the header files and libraries needed for C++
development. This includes rewritten implementation of STL.

%package -n compat-libstdc++-48-static
Summary: Static libraries for the GNU standard C++ library
Group: Development/Libraries
Requires: compat-libstdc++-48-devel = %{version}-%{release}
Autoreq: true
%if "%{version}" != "%{gcc_version}"
%endif

%description -n compat-libstdc++-48-static
...
Group: Development/Languages
Requires: compat-gcc-48 = %{version}-%{release}
Requires: compat-libgfortran-48 = %{version}-%{release}
...
%package -n compat-libgfortran-48
Summary: Fortran compatibility runtime
Group: System Environment/Libraries
Autoreq: true
%if %{build_libquadmath}
Requires: libquadmath = %{version}-%{release}
...
%description -n compat-libgfortran-48
This package contains Fortran shared library which is needed to run
Fortran dynamically linked programs.

%package -n compat-libgfortran-48-static
...
%description -n compat-libgfortran-48-static
This package contains static Fortran libraries.

%package -n compat-libgomp-48
Summary: GCC OpenMP v3.0 shared support library for compatibility compiler
Group: System Environment/Libraries
%if "%{version}" != "%{gcc_version}"
%endif

%description -n compat-libgomp-48
This package contains GCC shared support library which is needed
for OpenMP v3.0 compatibility compiler support.
...
%patch1500 -p1 -b .asan-signal~
%patch1501 -p1 -b .sanitizers~
%patch1502 -p1 -b .ucontext~
...
cat > gcc64 <<"EOF"
#!/bin/sh
exec /usr/bin/gcc -std=gnu89 -m64 "$@"
EOF
chmod +x gcc64
CC=`pwd`/gcc64
%endif
%ifarch ppc64 ppc64le ppc64p7
if gcc -std=gnu89 -m64 -xc -S /dev/null -o - > /dev/null 2>&1; then
  cat > gcc64 <<"EOF"
#!/bin/sh
exec /usr/bin/gcc -std=gnu89 -m64 "$@"
EOF
...
%else
GCJFLAGS="$OPT_FLAGS" make %{?_smp_mflags} BOOT_CFLAGS="$OPT_FLAGS" STAGE1_CXXFLAGS="-O2 -g -std=gnu++98" profiledbootstrap
%endif
...
for i in $RPM_BUILD_ROOT%{_prefix}/bin/{*gcc,*++,gcov,gfortran}; do
  mv -f $i ${i}48
done
...
%post -n compat-libstdc++-48 -p /sbin/ldconfig

%postun -n compat-libstdc++-48 -p /sbin/ldconfig
...
%post -n compat-libgfortran-48 -p /sbin/ldconfig

%postun -n compat-libgfortran-48 -p /sbin/ldconfig

%post -n compat-libgomp-48 -p /sbin/ldconfig

%postun -n compat-libgomp-48 -p /sbin/ldconfig
...
%{_prefix}/bin/sparc-%{_vendor}-%{_target_os}-gcc48
%endif
%ifarch ppc64 ppc64p7
%{_prefix}/bin/ppc-%{_vendor}-%{_target_os}-gcc48
%endif
%{_prefix}/bin/%{gcc_target_platform}-gcc48
%dir %{_prefix}/lib/gcc
...
%files c++
%defattr(-,root,root,-)
%{_prefix}/bin/%{gcc_target_platform}-*++48
%{_prefix}/bin/g++48
%dir %{_prefix}/lib/gcc
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}/%{gcc_version}
...
%files -n compat-libstdc++-48-devel
%defattr(-,root,root,-)
...
%files -n compat-libstdc++-48-static
%defattr(-,root,root,-)
%dir %{_prefix}/lib/gcc
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}/%{gcc_version}
...
%files -n compat-libgfortran-48
%defattr(-,root,root,-)
%{_prefix}/%{_lib}/libgfortran.so.3*

%files -n compat-libgfortran-48-static
%defattr(-,root,root,-)
%dir %{_prefix}/lib/gcc
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}/%{gcc_version}
